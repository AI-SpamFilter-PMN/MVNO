...
| [send_vty_sms.sh](scripts/testing/send_vty_sms.sh) | Osmocom VTY Shell (`TCP 4254`) | Sends command to OsmoSMSC Cisco-style operator console. | `./send_vty_sms.sh 15551234567 15557654321 "VTY SMS"` |
