...
| :--- | :--- | :--- | :--- |
| [record_mic_call.sh](record_mic_call.sh) | **Laptop Microphone ➔ Vosk ASR** | Records live audio from laptop mic and transcribes it via Vosk ASR. | `./record_mic_call.sh 5` |
